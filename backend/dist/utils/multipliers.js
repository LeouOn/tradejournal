...
exports.SYMBOL_SPECS = void 0;
exports.getSymbolMultiplier = getSymbolMultiplier;
exports.getSymbolTickSize = getSymbolTickSize;
exports.validatePriceProximity = validatePriceProximity;
...
function getSymbolMultiplier(symbol) {
    ...
    for (const prefix of Object.keys(exports.SYMBOL_SPECS)) {
        if (cleanSymbol.startsWith(prefix)) {
            return exports.SYMBOL_SPECS[prefix].multiplier;
        }
    }
...
function getSymbolTickSize(symbol) {
    ...
    for (const prefix of Object.keys(exports.SYMBOL_SPECS)) {
        if (cleanSymbol.startsWith(prefix)) {
            return exports.SYMBOL_SPECS[prefix].tickSize;
        }
    }
 ...
 */
function validatePriceProximity(price1, price2) {
